...
void loop(void) 
{
  ...
  // Map resistance to volume.
    ...
    Serial.print(battery_level / 100 * (1.32 - 1.261) + 1.261, 2); // V
    // Serial.println("V");
  ...
  float battery_read()
  {
      ...
      const float battery_max = 1.320; //maximum voltage of battery
      const float battery_min = 1.261;  //minimum voltage of battery before shutdown

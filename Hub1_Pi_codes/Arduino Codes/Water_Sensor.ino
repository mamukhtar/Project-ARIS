...
#define ZERO_VOLUME_RESISTANCE    2600    // Resistance value (in ohms) when no liquid is present.
#define CALIBRATION_RESISTANCE    650    // Resistance value (in ohms) when liquid is at max line.
#define CALIBRATION_VOLUME        600    // Volume (in any units) when liquid is at max line.

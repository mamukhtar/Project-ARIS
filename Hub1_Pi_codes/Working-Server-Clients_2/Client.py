...
class SensorClient:
    ...
    def get_filename_1(self):
        ...
        filename_1 = f"/home/sensor-hub1/Documents/Pi_codes/Hub1_data/Hub1_sensor_data_{self.file_num_1}.csv"  
    ...
    def get_filename_2(self):
        ...
        filename_2 = f"/home/sensor-hub1/Documents/Pi_codes/Hub2_data/Hub2_sensor_data_{self.file_num_2}.csv"  

...
directory_path = "/home/sensor-hub1/Documents/Pi_codes/Hub1_data/"

# Specify the directory path to save the consumption CSV files
consu_directory_path = os.path.join(directory_path, "Hub1_consu_data")
...
if not os.path.exists(consu_directory_path):
    ...
    print("Created Hub1_consu_data folder")
...
while True:
    ...
    if consu_row_counter % max_rows_per_file == 0:
        ...
        consu_file_path = os.path.join(consu_directory_path, "Hub1_consu_data_{}.csv".format(consu_file_number))

...
fieldnames = ['Time', 'Sensor1a', 'Amb_Temp', 'Sensor1b', 'Accel_X', 'Sensor1c', 'Accel_Y', 'Sensor1d','Accel_Z', 
              'Sensor2a', 'Volume', 'Sensor2b', 'Volume_%', 'Sensor3a', 'Batttery_Level_%', 'Sensor4a',
              'Pressure', 'Sensor4b', 'Pressure_%', 'Sensor5a', 'Body_Temp_C', 'Sensor5b', 'Body_Temp_F', 'Sensor6a',
              'Heart_rate', 'BPM', 'IBI']

# Define the folder name
folderName = "Hub2_data"
...
while True:
    ...
    if line_count >= max_lines:
        ...
        fileName2 = os.path.join(folderName, 'Hub2_sensor_data_' + str(file_count) + '.csv')
